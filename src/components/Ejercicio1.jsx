  ...
  render() {
    return (
      <div id="ej1">
        ...
        <ul>
          <li>
            Sustituye el título del examen por componente llamado <b>Menu</b>{' '}
            que implemente una barra de navegación que permita cambiar entre los
            distintos ejercicios como si de distintas páginas se tratase. Se ha
            ...
            <ul>
              ...
              <li>
                El menú usará la variante de color de fondo y letras "light", se
                mostrará solamente si el tamaño de la pantalla es menor que el
                tamaño grande de Bootstrap, el menú contextual surgirá desde la
                parte izquierda y junto al título del examen se mostrará la
                imagen logo.png, ubicada en /src/assets/images{' '}
                <b> - 0,75 puntos</b>
              </li>
              <li>
